...
import com.jobscience.search.dao.DaoRoHelper;
...
public class AppConfig extends AbstractModule {
	...
	public static String JSS_VERSION = "DROP-CUSTOMFIELD-07";
    ...
    private Matcher perfClassMatchers(){
        ...
        m = m.or(new ClassSetMatcher(DaoRwHelper.class));
        m = m.or(new ClassSetMatcher(DaoRoHelper.class));
