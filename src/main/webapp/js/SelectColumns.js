    ...
    brite.registerView("SelectColumns", {emptyParent: false,parent:".search-result"},
        {
            ...
            create: function (data, config) {
                ...
                return render("SelectColumns", {columns:colOrders});
            },
            ...
            events: {
                ...
                "bdragstart; li": function (event) {
                    ...
                    var pos = $li.position();
                    $clone.css({"display": "block","position":"absolute", opacity:0.5, left: pos.left, top: pos.top,
                        "cursor": "pointer", "width":$li.outerWidth()});
                ...
                "bdragmove; li": function (e) {
                    ...
                    var pos = {top: ppos.top + e.bextra.deltaY, left: 10}
                    $clone.css(pos);
